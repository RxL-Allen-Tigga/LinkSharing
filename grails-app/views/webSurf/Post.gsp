            ...
            <div class="border rounded border-dark p-2 mb-2 text-bg-light">
                ...
                <div class="row ">
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                <h5>${resource.createdBy.firstName.take(15)} ${resource.createdBy.lastName?.take(15)}</h5>
                            </div>

                            <div class="col-5">
                                <g:link controller="webSurf" action="Topic" params="[id: resource.topic?.id]">
                                    <h5>${resource.topic.name.take(15)}</h5>
                                </g:link>
                            </div>
                        </div>
                        ...
                        <%-- Session user and user rating --%>
                            ...
                            <g:form controller="resourceRatingOperations" action="saveRating">
                                ...
                                <g:submitButton name="rate" value="Rate" class="btn btn-primary hover-pop"/>
                            </g:form>
