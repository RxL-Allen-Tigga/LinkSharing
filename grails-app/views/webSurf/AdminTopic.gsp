...
<div class="container">
    ...
    <div class="row align-items-start text-bg-light p-2 rounded-2 border border-dark p-2 mb-2">
        ...
        <table class="table table-striped mb-2">
            ...
            <tr>
                <th>
                    <g:link controller="webSurf" action="AdminTopic"
                ...
                <th>
                    <g:link controller="webSurf" action="AdminTopic"
                            params="[sort: 'name', order: (sortField == 'name' && order == 'asc') ? 'desc' : 'asc']">
                        Name
                        <g:if test="${sortField == 'name'}">
                            <span class="sort-indicator">${order == 'asc' ? '▲' : '▼'}</span>
                        </g:if>
                    </g:link>
                </th>
                ...
                <th>
                    <g:link controller="webSurf" action="AdminTopic"
                            params="[sort: 'visibility', order: (sortField == 'visibility' && order == 'asc') ? 'desc' : 'asc']">
                        Visibility
                        <g:if test="${sortField == 'visibility'}">
                            <span class="sort-indicator">${order == 'asc' ? '▲' : '▼'}</span>
                        </g:if>
                    </g:link>
                </th>
